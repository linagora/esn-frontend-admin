...
describe('The adminElasticsearchController', function() {

  var $controller, $rootScope, $stateParams, $scope;
  var adminDomainConfigService;
  var CONFIG_NAME = 'elasticsearch';
  ...
  function initController(scope) {
    ...
    var controller = $controller('adminElasticsearchController', { $scope: $scope });
  ...
  it('should get Elasticsearch configuration from server on init', function() {
